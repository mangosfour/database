...
DELETE FROM `conditions` WHERE `value1` = 11892;
INSERT INTO `conditions` (`condition_entry`,`type`,`value1`,`value2`,`comments`) VALUES
(@condition+1,8,11892,0,'Arch Druid Lathorius - Gossip');

UPDATE `gossip_menu` SET `condition_id` = @condition+1 WHERE `entry` = 9188 AND `text_id` = 12511;
