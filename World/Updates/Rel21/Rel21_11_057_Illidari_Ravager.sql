...
BEGIN
    ...
    SET @cNewDescription = 'Illidari Ravager';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Illidari Ravager';
...
UPDATE `creature_template` SET `AIName` = 'EventAI' WHERE `Entry` = 22857;
DELETE FROM creature_ai_scripts WHERE `creature_id` = 22857;
