...
BEGIN
    ...
    SET @cNewDescription = 'The Eye of the Storm';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'The Eye of the Storm Quest credit';
	...
	-- Quest credit for both Alliance and Horde Quest - The Eye of the Storm.
